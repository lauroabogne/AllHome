...
interface GroceryItemDAO {
    ...
    @Query("SELECT * from grocery_items WHERE item_name =:itemName AND unit =:unit AND grocery_list_unique_id =:autoGenerateId AND item_status = 0 LIMIT 1")
    fun getItemByGroceryListAutoGeneratedIDnameAndUnit(autoGenerateId:String,itemName:String, unit:String):GroceryItemEntity
