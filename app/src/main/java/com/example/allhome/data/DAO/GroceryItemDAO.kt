...
interface GroceryItemDAO {
    ...
    @Query("UPDATE grocery_items SET datetime_modified= :datetimeModified WHERE id=:id")
    fun updateItemQuantityDatetimeModified(id:Int,datetimeModified:String):Int
    ...
    @Query("SELECT * from grocery_items WHERE item_name =:itemName AND unit =:unit AND  item_status = :status LIMIT 1")
    fun getItemByNameAndUnitWithStatus(itemName:String, unit:String,status:Int):GroceryItemEntity
