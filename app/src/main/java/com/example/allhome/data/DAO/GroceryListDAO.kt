...
interface GroceryListDAO {
    ...
    @Query("UPDATE grocery_lists SET item_status=:status,datetime_status_updated=:datetimeStatusUpdated WHERE auto_generated_unique_id =:autoGeneratedUniqueId")
    suspend fun updateGroceryListAsActive(autoGeneratedUniqueId:String,datetimeStatusUpdated:String,status:Int)

    @Query("UPDATE grocery_lists SET item_status=:status,datetime_status_updated=:datetimeStatusUpdated WHERE auto_generated_unique_id =:autoGeneratedUniqueId")
    suspend fun updateGroceryListAsPermanentlyDeleted(autoGeneratedUniqueId:String,datetimeStatusUpdated:String,status:Int)
