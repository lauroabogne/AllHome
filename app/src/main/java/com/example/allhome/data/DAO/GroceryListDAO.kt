...
interface GroceryListDAO {
    @Insert
    fun addItem(groceryListEntity: GroceryListEntity)
    ...
    @Query("SELECT *,(SELECT COUNT(*) FROM grocery_items WHERE grocery_list_unique_id =grocery_lists.auto_generated_unique_id ) AS itemCount FROM grocery_lists")
    fun selectGroceryListWithItemCount():LiveData<List<GroceryListWithItemCount>>
