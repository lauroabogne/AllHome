                ...
                popupMenu.setOnMenuItemClickListener(PopupMenu.OnMenuItemClickListener {
                    ...
                    when (it.itemId) {
                        ...
                        R.id.add_to_expenses_report_menu-> {
                            ...
                            Log.e(GroceryListFragment.TAG," 3")
                            autoGeneratedUniqueId?.let {
                                mGroceryListFragmentViewModel.coroutineScope.launch {
                                    ...
                                    val groceryItemEntities = mGroceryListFragmentViewModel.getBoughtGroceryListItems(groceryListFragment.requireContext(),autoGeneratedUniqueId)
                                    ...
                                    if(groceryItemEntities.isEmpty()){
                                        withContext(Main) {
                                            Toast.makeText(groceryListFragment.requireContext(),"Failed to save in expenses. You din not buy any item in this grocery list.",Toast.LENGTH_SHORT).show()
                                        }
                                        return@launch
                                    }
