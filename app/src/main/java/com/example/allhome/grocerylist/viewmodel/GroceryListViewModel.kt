...
class GroceryListViewModel(groceryListEntityParams: GroceryListEntity? = null, groceryItemParams: GroceryItemEntity?) : ViewModel() {
    ...
    suspend fun getGroceryItems(context:Context,groceryListAutoGeneratedId:String):ArrayList<GroceryItemEntity>{
        return AllHomeDatabase.getDatabase(context).groceryItemDAO().getGroceryListItems(groceryListAutoGeneratedId) as ArrayList<GroceryItemEntity>
    ...
    suspend fun deleteGroceryListItem(context:Context,id:Int,groceryListAutoGeneratedId: String){
