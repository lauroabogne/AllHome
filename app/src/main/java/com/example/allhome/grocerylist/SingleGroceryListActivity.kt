    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this, object: OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                if(isViewingImage){
                    dataBindingUtil.imageContainerIncludedLayout.imageViewingCloseButton.performClick()
        ...
        dataBindingUtil.imageContainerIncludedLayout.imageViewingCloseButton.setOnClickListener(closeImageViewingClickLister)
        iniItems()
...
//            }
    ...
    private val productImageClickListener = View.OnClickListener {
        ...
        val mainLayout = dataBindingUtil.container
    ...
    private val closeImageViewingClickLister = View.OnClickListener {
        ...
        ImageUtil.zoomOutImageFromThumb(selectedImageThumbnailView, mainLayout,  imageContainer, animationDuration)
