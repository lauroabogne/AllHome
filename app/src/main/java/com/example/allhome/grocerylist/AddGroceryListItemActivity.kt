...
class AddGroceryListItemActivity : AppCompatActivity() {
   ...
   // var croppedImageUri:Uri? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val initGroceryItemEntity = GroceryItemEntity("", 0, "", 0.0, "", 0.0, "", "", "", 0)
   ...
   fun showIntentChooser(){
    ...
    fun addRecord() {
        ...
        val groceryItemEntity = GroceryItemEntity(
            ...
            unit = unit, pricePerUnit = doublePricePerUnit, category = category, notes = notes, imageName = imageName, bought = 0
        )
        // hide soft keyboard
